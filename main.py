...
# ============ DATA DIRECTORY SETUP (NO PERSISTENT DISK) ============
# Persistent disk save data removed. Data is stored in a fresh local dir.
...
def load_all_data():
    ...
    print(f"   - Stock: GP={gamepass_stock}")
...
async def send_level_up_dm(member, new_sp, old_sp):
    try:
        ...
        embed.set_footer(text="13bux • ขอบคุณที่ใช้บริการ 💖")
...
class LevelCheckView(View):
    ...
    async def check_callback(self, interaction: discord.Interaction):
        ...
        embed.set_footer(text="13bux • 1 โรบัคที่ซื้อ = 1 SP")
        ...
        async def notes_cb(interaction):
            ...
            try:
                ...
                try:
                    ...
                    dm_embed.set_footer(text="13bux 🌸")
...
class PaymentView2(View):
    ...
    async def bank_callback(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="⚠️ โน๊ตสลิป", value="เติมโรบัค 13bux", inline=False)
        embed.set_footer(text="13bux 🌸 • ช่องทางสำรอง")
...
class BackButtonView2(View):
    ...
    async def back_callback(self, interaction: discord.Interaction):
        embed = discord.Embed(
            title="🌸 ช่องทางโอนเงิน 13bux (สำรอง)💰",
            description="กรุณาเลือกช่องทางการชำระเงินด้านล่าง",
            color=0xFFA500
        )
        embed.set_footer(text="13bux 🌸")
